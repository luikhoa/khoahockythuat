/**
 * linkcheck.ts — Kiểm tra liên kết đáng ngờ.
 *
...
const THƯƠNG_HIỆU: Record<string, string[]> = {
...
const HẬU_TỐ_ĐÔI = new Set([
  "com.vn", "net.vn", "org.vn", "edu.vn", "gov.vn", "info.vn",
  "biz.vn", "co.uk", "com.au", "co.jp", "com.cn", "com.br",
]);

function tênMiềnChính(host: string): string {
  const p = host.split(".");
...
function check(rawUrl: string): LinkCheckResult {
...
export const CyberShieldLink = { check };
